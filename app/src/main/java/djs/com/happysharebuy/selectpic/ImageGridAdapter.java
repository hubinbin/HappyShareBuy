...
public class ImageGridAdapter extends BaseAdapter {
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if(type == TYPE_CAMERA){
			view = mInflater.inflate(R.layout.select_list_item_camera, viewGroup, false);
			view.setTag(null);
		}else if(type == TYPE_NORMAL){
			ViewHolde holde;
			if(view == null){
				view = mInflater.inflate(R.layout.select_list_item_image, viewGroup, false);
		...
		void bindData(final Image data){
			...
			if(showSelectIndicator){
				...
				if(mSelectedImages.contains(data)){
					// 设置选中状态
					indicator.setImageResource(R.mipmap.icon_select_pic_focused);
					mask.setVisibility(View.VISIBLE);
				}else{
					// 未选择
					indicator.setImageResource(R.mipmap.icon_select_pic_nomal);
