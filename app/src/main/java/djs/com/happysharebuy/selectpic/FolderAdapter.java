...
public class FolderAdapter extends BaseAdapter {
	...
	public FolderAdapter(Context context){
		...
		mImageSize = mContext.getResources().getDimensionPixelOffset(R.dimen.mexue_36_dip);
	}
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		ViewHolder holder;
		if(view == null){
			view = mInflater.inflate(R.layout.selected_list_item_folder, viewGroup, false);
